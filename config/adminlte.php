    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Profile',
            'url' => '/student/profile',
            'active' => ['/student/profile', '/student/profile/*'],
            'icon' => 'far fa-fw fas fa-user',
            'roles' => 'student',
        ],
        [
            'text' => 'Info Kelompok',
            'url' => '/student/group',
            'active' => ['/student/group', '/student/group/*'],
        ...
        [
            ...
            'active' => ['/student/proker/list', '/student/proker/list/*'],
        ...
        [
            ...
            'active' => ['/student/proker/propose', '/student/proker/propose/*'],
        ...
        [
            ...
            'active' => ['/student/proker/daily-report', '/student/proker/daily-report/*'],
        ...
        [
            ...
            'active' => ['/student/proker/final-report/revisi', '/student/proker/final-report/revisi/*'],
        ...
        [
            'text' => 'Profile',
            'url' => '/dosen/profile',
            'active' => ['/dosen/profile', '/dosen/profile/*'],
            'icon' => 'far fa-fw fas fa-user',
            'roles' => 'dosen',
        ],
        [
            'text' => 'Kelompok Didik',
            'url' => '/dosen/student',
            'active' => ['/dosen/student', '/dosen/student/*'],
        ...
        [
            'text' => 'Program Kerja ',
            'url' => '/dosen/proker',
            'active' => ['/dosen/proker', '/dosen/proker/*'],
            'icon' => 'far fa-fw fas fa-briefcase',
            'roles' => 'dosen',
        ],
        ...
        [
            ...
            'active' => ['/dosen/dailyreport', '/dosen/dailyreport/*'],
            'icon' => 'far fa-fw far fa-newspaper',
            'roles' => 'dosen',
        ],
        ...
        [
            ...
            'active' => ['/dosen/finalreport', '/dosen/finalreport/*'],
